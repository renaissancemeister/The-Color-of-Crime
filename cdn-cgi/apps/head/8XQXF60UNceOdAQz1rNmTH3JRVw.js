;window.CloudflareApps=window.Eager=window.CloudflareApps||window.Eager||{};window.CloudflareApps=window.CloudflareApps||{};CloudflareApps.siteId="e5d2ae097c742fcb16dd1433207ec1d7";CloudflareApps.installs=CloudflareApps.installs||{};;(function(){CloudflareApps.internal=CloudflareApps.internal||{};var errors=[];CloudflareApps.internal.placementErrors=errors;var errorHashes={}
...
return false;}})();;CloudflareApps.installs["u99ZbMUgiuk8"]={appId:"lMxPPXVOqmoE",scope:{}};;CloudflareApps.installs["u99ZbMUgiuk8"].options={"id":"UA-2642027-3","social":true};;if(CloudflareApps.matchPage(CloudflareApps.installs['u99ZbMUgiuk8'].URLPatterns)){(function(i,s,o,g,r,a,m){i['GoogleAnalyticsObject']=r;i[r]=i[r]||function(){(i[r].q=i[r].q||[]).push(arguments)},i[r].l=1*new Date();a=s.createElement(o),m=s.getElementsByTagName(o)[0];a.async=1;a.src=g;m.parentNode.insertBefore(a,m)})(window,document,'script','//www.google-analytics.com/analytics.js','ga');};if(CloudflareApps.matchPage(CloudflareApps.installs['u99ZbMUgiuk8'].URLPatterns)){(function(){var options=CloudflareApps.installs['u99ZbMUgiuk8'].options
